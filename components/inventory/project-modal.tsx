  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute right-3 top-3 z-10 rounded-full bg-white/90 p-1.5 text-gray-600 shadow-sm transition-colors hover:bg-white"
          aria-label="Tutup"
        >
          <X className="h-4 w-4" />
        </button>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {project.github && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-lg border border-gray-300 px-3 py-2 text-sm font-medium transition-colors hover:bg-gray-50"
              >
