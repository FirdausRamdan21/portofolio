...
export const activities: Activity[] = [
  {
    ...
    role: "Wakil Ketua",
    description:
      "Sebagai Wakil Ketua Japanese Club SMKN 8 Jakarta, saya membantu pengurus menjalankan kegiatan organisasi dan memastikan program kerja berjalan secara terarah. Peran ini saya jalankan selama periode 2025–2026 melalui koordinasi bersama ketua dan pengurus lainnya.<br><br>" +
  ...
  },
  {
    id: "perpustakaan",
    slug: "perpustakaan",
    title: "Volunteer Perpustakaan SMKN 8 Jakarta — Divisi Web",
    organization: "Perpustakaan Sekolah",
    role: "Web Division",
    description:
      "Sebagai volunteer pada Divisi Web Perpustakaan SMKN 8 Jakarta, saya membantu pengelolaan informasi dan administrasi perpustakaan melalui sistem berbasis web. Kegiatan ini berlangsung selama periode 2025–2026 dan menjadi pengalaman saya dalam menerapkan web development pada kebutuhan nyata di lingkungan sekolah.<br><br>" +
      "Tugas saya meliputi pengelolaan data buku, dukungan administrasi, serta pembaruan informasi yang dapat diakses oleh siswa melalui website. Pekerjaan tersebut menuntut ketelitian, kerapian data, dan pemahaman terhadap kebutuhan pengguna.<br><br>" +
  ...
  },
  {
    ...
    description:
      "Sebagai Event Organizer dan Moderator dalam komunitas Minerva Cafe, saya terlibat dalam perencanaan dan pelaksanaan kegiatan komunitas secara daring sejak Januari 2026. Peran ini berfokus pada pengelolaan acara sekaligus menjaga ruang komunitas tetap tertib dan nyaman.<br><br>" +
  ...
  },
  {
    ...
    description:
      "Saya mengikuti pembelajaran mandiri melalui platform freeCodeCamp sejak Mei 2026 untuk memperkuat dasar pengembangan web. Proses belajar dilakukan secara bertahap melalui materi, latihan, dan proyek yang tersedia dalam kurikulum.<br><br>" +
  ...
  },
   {
    ...
    slug: "freecodecamp-responsive-certificate",
    title: "Certificate Responsive",
    organization: "freeCodeCamp",
    role: "Certificate Holder",
    description:
  ...
  },
  {
    ...
    role: "Creator & Editor",
    description:
      "Northink adalah kegiatan pembuatan konten edukasi digital yang saya jalankan melalui TikTok sejak Juni 2026. Kontennya membahas programming dan teknologi dengan pendekatan yang ringkas serta mudah dipahami oleh audiens umum.<br><br>" +
